...
return [
    ...
    | por la clase Validator. Algunas reglas tienen varias versiones, como
    ...
    */
    ...
    'uploaded' => 'El campo :attribute no se pudo subir. Puede que el archivo sea demasiado pesado.',
    ...
    */
    ...
    'custom' => [
        // Aquí puedes personalizar mensajes por atributo+regla, ej:
        // 'email' => [
    ...
    /*
    |--------------------------------------------------------------------------
    | Nombres legibles de los atributos, en español
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para reemplazar el marcador :attribute
    | en los mensajes de arriba por algo más amigable, como "Correo" en
    | vez de "email". Esto ayuda a hacer el mensaje más legible.
    |
    */
